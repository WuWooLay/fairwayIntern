...
(function(exports) {
	...
	function checkMagicNumberAndVersion(
		stream,
		offset,
		expectedBinaryTagLead,
		expectedBinaryTagTrail,
		...
		if (binaryTagLead !== expectedBinaryTagLead) {
			throw new Error(
				'Unexpected magic number lead; expected ' +
		...
		if (binaryTagTrail !== expectedBinaryTagTrail) {
			throw new Error(
				'Unexpected magic number trail; expected ' +
		...
		if (expectedBinaryVersion !== -1) {
			...
			if (binaryVersion !== expectedBinaryVersion) {
				throw new Error(
					'Unexpected serial version number; expected ' +
	...
	var BinaryMarkov = (function() {
		...
		BinaryMarkov.BINARY_TAG_LEAD = 1112359250;
		BinaryMarkov.BINARY_TAG_TRAIL = 1263490592;
		BinaryMarkov.BINARY_VERSION = 0;
		return BinaryMarkov;
	})();
	var ZawgyiUnicodeMarkovModel = (function() {
		...
		ZawgyiUnicodeMarkovModel.BINARY_TAG_LEAD = 1431981391;
		ZawgyiUnicodeMarkovModel.BINARY_TAG_TRAIL = 1145392160;
		return ZawgyiUnicodeMarkovModel;
	})();
	var ZawgyiDetector = (function() {
