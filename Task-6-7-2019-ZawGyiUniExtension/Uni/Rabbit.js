var Rabbit = (function(o) {
  function r(f) {
    if (t[f]) return t[f].exports;
    var m = (t[f] = { i: f, l: !1, exports: {} });
    return o[f].call(m.exports, m, m.exports, r), (m.l = !0), m.exports;
  }
  var t = {};
  return (
    (r.m = o),
    ...
    var f = function(o) {
        return $(
          [
            ...
            { from: "ဏ္ဍ", to: "႑" },
            { from: "ဋ္ဋ", to: "႗" },
            { from: "([က-အႏဩ႐])([ၠ-ၩၬၭၰ-ၼႅႊ])?([ျ-ှ]*)?ေ", to: "ေ$1$2$3" },
            { from: "ြှ", to: "ြႇ" },
      ...
      m = function(o) {
        return $(
          [
            ...
            { from: "ႊ", to: "ွှ" },
            { from: "ျၤ", to: "ၤျ" },
            { from: "(ေ)?([က-အ])ၤ", to: "င်္$1$2" },
            { from: "(ေ)?([က-အ])ႋ", to: "င်္$1$2ိ" },
            { from: "(ေ)?([က-အ])ႌ", to: "င်္$1$2ီ" },
            { from: "(ေ)?([က-အ])ႍ", to: "င်္$1$2ံ" },
            { from: "ႎ", to: "ိံ" },
            { from: "ႏ", to: "န" },
            { from: "႐", to: "ရ" },
            { from: "႑", to: "ဏ္ဍ" },
